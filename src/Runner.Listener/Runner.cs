                ...
                try
                {
                    ...
                    while (!HostContext.RunnerShutdownToken.IsCancellationRequested)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                bool selfUpdateOptOut;
                                if (bool.TryParse(Environment.GetEnvironmentVariable("GITHUB_ACTIONS_RUNNER_SELFUPDATE_OPT_OUT"), out selfUpdateOptOut) && selfUpdateOptOut)
                                {
                                    Trace.Info("Refresh message received, skip autoupdate since opted out.");
                                }
